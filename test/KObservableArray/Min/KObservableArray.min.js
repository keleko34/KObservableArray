...
"__kbdatadeletelisteners"),b=new l("splice",a,d,arguments);if(!0!==f(b)){var g=[],k=v(b.args[2]),r=void 0!==b.args[2]?k?b.args[2].length:1:0,p=0;if(0!==e&&void 0!==this[b.key-1+b.args[1]]){for(var q=0,m=b.args[1];q<m;q++)if(p=b.key+q,d.key=p,d.type="remove",d.value=this[p],b.key=p,b.type="remove",!0!==f(b)&&!0!==t(d)){g.push(this[p-g.length]);for(var n=b.key,u=this.length-1;n<u;n++)this[n]=this[n+1]}else--b.args[1];this.length-=b.args[1];q=0;for(m=b.args[1];q<m;q++)b.type="postremove",b.key=this.length+
q,f(b)}if(0!==r)for(k||(b.args[2]=[b.args[2]]),q=0,m=r;q<m;q++)if(p=b.key+q,d.key=p,d.type="add",d.listener="__kbdatacreatelisteners",d.value=b.args[2][q],b.type="add",!0!==f(b)&&!0!==t(d)){n=this.length;for(u=p;n>u;n--)void 0===this[n]?(Object.defineProperty(this,n,w.call(this,this[n-1],n)),b.key=n,b.type="postadd",f(b)):this[n]=this[n-1];this[p]=b.args[2][q]}b.type="postsplice";f(b)}return g}),push:b(function(a){var e=new h(this,this.length,"push",a,void 0,arguments,"__kbdatacreatelisteners"),c=
new l("push",this.length,e,arguments);!0!==f(c)&&(e.type="add",e.value=c.args[0],e.key=c.key,c.type="add",!0!==f(c)&&!0!==t(e)&&(Object.defineProperty(this,c.key,w.call(this,c.args[0],c.key)),c.type="postadd",f(c),c.type="postpush",f(c)));return this.length}),pop:b(function(){var a=new h(this,this.length-1,"pop",this[this.length-1],void 0,arguments,"__kbdatadeletelisteners"),e=new l("pop",this.length-1,a,arguments);if(!0!==f(e)){var c=this[this.length-1];a.type="remove";e.type="remove";if(!0!==f(e)&&
!0!==t(a))return--this.length,e.type="postremove",f(e),e.type="postpop",f(e),c}return null}),shift:b(function(){var a=new h(this,0,"shift",this[0],void 0,arguments,"__kbdatadeletelisteners"),e=new l("shift",0,a,arguments);if(!0!==f(e)){var c=this[e.key];a.type="remove";a.key=e.key;e.type="remove";if(!0!==f(e)&&!0!==t(a)){for(var a=e.key,d=this.length-1;a<d;a++)this[a]=this[a+1];--this.length;e.type="postremove";f(e);e.type="postshift";f(e);return c}}return null}),unshift:b(function(){var a=new h(this,
